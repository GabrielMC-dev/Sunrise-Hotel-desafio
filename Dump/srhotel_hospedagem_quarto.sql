...
CREATE TABLE `hospedagem_quarto` (
  ...
  CONSTRAINT `hospedagem_quarto_ibfk_1` FOREIGN KEY (`id_hospedagem`) REFERENCES `hospedagem` (`id`),
  CONSTRAINT `hospedagem_quarto_ibfk_2` FOREIGN KEY (`id_quarto`) REFERENCES `quarto` (`id`)
